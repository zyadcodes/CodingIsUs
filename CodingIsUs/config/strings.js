...
export default {
  ...
  Related: 'Related',
  Length: 'Length: ',
  CodingIsUsRequiresInternet:
    'Coding is Us requires an active internet connection! Please try again when you are connected.',
  Whoops: 'Whoops',
  TryAgain: 'Try Again',
  Facebook: 'Facebook',
  Instagram: 'Instagram',
  CodingIsUs: 'Coding is Us',
  WhatDoYouWantToLearnAbout: 'What do you want to learn about today?',
  ...
  YouHaveCompletedThe: 'You have completed the ',
  Guide: ' course!',
  ShareThisWithYourFriends: 'Share this achievement with your friends!',
  Share: 'Share',
  CheckItOut: 'Check it out!',
  IJustCompletedThe: 'I just completed the ',
  CourseOnCodingIsUs: ' course on Coding is Us!',
  Done: 'Done',
  CodeInTheApp: 'Code in the app!',
  CreateFreeAccount: 'Create a free account or login now!',
