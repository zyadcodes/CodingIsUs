// This is going to be the Terms of Service screen for the website
  ...
  return (
    <div>
      <MetaTags>
        <meta
          name="description"
          content="Understand our rules and terms of service when it comes to usage of our website"
        />
      </MetaTags>
        ...
        <div className={"container"}>
          ...
          <div className={"textContainer"}>
            ...
            <p className={"bigTextStyle black"}>
              ...
              entity (you), and Coding is Us, located at United States (we, us),
              concerning your access to and use of the Coding is Us
              (https://codingisus.com) website as well as any related
            ...
            <p className={"bigTextStyle black"}>
              The Site provides the following services: We give out coding
              tutorials and practices for free. (Services). You agree that by
            ...
            <p className={"bigTextStyle black"}>
              1.2 &nbsp;The supplemental policies set out in Section 1.7 below,
              as well as any supplemental terms and condition or documents that
            ...
            <p className={"bigTextStyle black"}>
              ...
              to register for the Site or use the Services without parental
              permission.&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
            ...
            <p className={"bigTextStyle black"}>
              ● &nbsp;Our Privacy Notice https://codingisus.com/privacy-policy,
              which sets out the terms on which we process any personal data we
              collect from you, or that you provide to us. By using the Site,
            ...
            <p className={"bigTextStyle black"}>
              ...
              viruses, Trojan horses, or other material that interferes with any
            ...
            <p className={"bigTextStyle black"}>
              3.1 &nbsp;Unless otherwise indicated, the Site and Services
            ...
            <p className={"bigTextStyle black"}>
              3.2 &nbsp;Except as expressly provided in these Terms and
            ...
            <p className={"bigTextStyle black"}>
              3.3 &nbsp;Provided that you are eligible to use the Site, you are
            ...
            <p className={"bigTextStyle black"}>
              3.4 &nbsp;You shall not (a) try to gain unauthorised access to the
            ...
            <p className={"bigTextStyle black"}>
              3.5 &nbsp;We shall (a) prepare the Site and Our Content with
            ...
            <p className={"bigTextStyle black"}>
              3.6 &nbsp;The content on the Site is provided for general
              ...
              before taking, or refraining from taking, any action on the basis
            ...
            <p className={"bigTextStyle black"}>
              3.7 &nbsp;Although we make reasonable efforts to update the
              information on our site, we make no representations, warranties or
              guarantees, whether express or implied, that Our Content on the
            ...
            <p className={"bigTextStyle black"}>
              4.1 &nbsp;The Site may contain links to websites or applications
            ...
            <p className={"bigTextStyle black"}>
              4.2 &nbsp;We accept no responsibility for adverts contained within
            ...
            <p className={"bigTextStyle black"}>
              5.1 &nbsp;We reserve the right at our sole discretion, to (1)
              monitor the Site for breaches of these Terms and Conditions; (2)
              take appropriate legal action against anyone in breach of
              applicable laws or these Terms and Conditions; (3) remove from the
              Site or otherwise disable all files and content that are excessive
              in size or are in any way a burden to our systems; and (4)
            ...
            <p className={"bigTextStyle black"}>
              5.2 &nbsp;We do not guarantee that the Site will be secure or free
            ...
            <p className={"bigTextStyle black"}>
              5.3 &nbsp;You are responsible for configuring your information
            ...
            <p className={"bigTextStyle black"}>
              6.1 &nbsp;We reserve the right to change, modify, or remove the
            ...
            <p className={"bigTextStyle black"}>
              6.2 &nbsp;We cannot guarantee the Site and Services will be
            ...
            <p className={"bigTextStyle black"}>
              6.3 &nbsp;There may be information on the Site that contains
            ...
            <p className={"bigTextStyle black"}>
              ...
              completeness of the Site&rsquo;s content and are not liable for
              any (1) errors or omissions in content: (2) any unauthorized
              ...
              comply with our obligations under these Terms and Conditions if
              such delay or failure is caused by an event beyond our reasonable
              control.&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
            ...
            <p className={"bigTextStyle black"}>
              7.2 &nbsp;Our responsibility for loss or damage suffered by
              you:&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
            ...
            <p className={"bigTextStyle black"}>
              ...
              the greater of (a) the sum of &pound;5000 or (b) the amount paid,
            ...
            <p className={"bigTextStyle black"}>
              ...
              office. Nothing in these Terms and Conditions will affect these
              legal rights. &nbsp; &nbsp;&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
            ...
            <p className={"bigTextStyle black"}>
              8.1 &nbsp;These Terms and Conditions shall remain in full force
              and effect while you use the Site or Services or are otherwise a
            ...
            <p className={"bigTextStyle black"}>
              8.2 &nbsp;Without limiting any other provision of these Terms and
            ...
            <p className={"bigTextStyle black"}>
              8.3 &nbsp;If we terminate or suspend your account for any reason
            ...
            <p className={"bigTextStyle black"}>
              9.1 &nbsp;If you access the Services via a mobile application,
            ...
            <p className={"bigTextStyle black"}>
              9.2 &nbsp;The following terms apply when you use a mobile
            ...
            <p className={"bigTextStyle black"}>
              ...
              limited to a non-transferable licence to use the application on a
            ...
            <p className={"bigTextStyle black"}>
              10.2 &nbsp;These Terms and Conditions and any policies or
              operating rules posted by us on the Site or in respect to the
              Services constitute the entire agreement and understanding between
              you and us. &nbsp;&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
            ...
            <p className={"bigTextStyle black"}>
              10.3 &nbsp;Our failure to exercise or enforce any right or
            ...
            <p className={"bigTextStyle black"}>
              10.4 &nbsp;We may assign any or all of our rights and obligations
            ...
            <p className={"bigTextStyle black"}>
              ...
              and Conditions is unlawful, void or unenforceable, that provision
            ...
            <p className={"bigTextStyle black"}>
              10.8 &nbsp;For consumers only &nbsp;- Please note that these Terms
              and Conditions, their subject matter and their formation, are
              governed by English law. You and we both agree that the courts of
              England and Wales will have exclusive jurisdiction expect that if
              you are a resident of Northern Ireland you may also bring
              proceedings in Northern Ireland, and if you are resident of
              Scotland, you may also bring proceedings in Scotland. If you have
              any complaint or wish to raise a dispute under these Terms and
            ...
            <p className={"bigTextStyle black"}>
              10.9 &nbsp;Except as stated under the Mobile Application section,
              a person who is not a party to these Terms and Conditions shall
            ...
            <p className={"bigTextStyle black"}>
              10.10 &nbsp;In order to resolve a complaint regarding the Services
              or to receive further information regarding use of the Services,
              please contact us by email at info@codingisus.com or by post
              to:&nbsp;
            </p>
            <p className={"bigTextStyle black"}>
              <br />
