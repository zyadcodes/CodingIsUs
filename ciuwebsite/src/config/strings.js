// The strings that will be used in this web app
export default {
  ...
  AboutUs: "About Us",
  AboutUsText:
    "Coding is Us is a community of innovators that are changing the world using technology. Through all of our different platforms, we inspire people to learn and start conversations about technology, programming, and much more!",
  WhoWeAre: "Who We Are",
  InstagramAboutMessage:
    "Follow us on Instagram to learn more about technology on a daily basis and to connect with us!",
  FacebookAboutMessage:
    "Check out our Facebook Page to learn more about different technology concepts and to connect with us!",
  TikTokAboutMessage: "Follow us on TikTok to get daily tech TikToks and more!",
  PodcastAboutMessage:
    "Tune into The Coding is Us Podcast to learn about technologies and how they work, as well as hear from guest speakers!",
  iOSAppAboutMessage:
    "Check out our mobile app to learn and practice coding all from your iPhone!",
  AndroidAppAboutMessage:
    "Check our mobile app on Android to learn and practice coding all from the palm of your hand!",
  EmailAboutMessage:
    "Have a question or just want to learn about coding? Reach out to us now!",
  Contact: "Contact",
  Learn: "Learn",
  Instagram: "Instagram",
  TheCodingIsUsMobileWebsite:
    "The Coding is Us website isn't available on mobile yet! Please visit it on a computer. Here's links the our app!",
  iOS: "iOS",
  Android: "Android",
  Facebook: "Facebook",
  TikTok: "TikTok",
  ...
  SubscribeToOurEmailList: "Subscribe for coding updates!",
  Practice: "Practice",
  Account: "Account",
  ...
  Subscribe: "Subscribe...",
  Copyright: "Coding is Us ©",
  PleaseEnterValidEmailAddress: "Please enter a valid email address.",
  EmailInUse: "This email is already in use. Please go back and log in",
  IncorrectEmailOrPassword:
    "The email/password you entered is incorrect. Please try again",
  Whoops: "Whoops",
  CreateAFreeAccount: "Create a free account or login now!",
  ...
  GetInTouchMessage:
    "Reach out to us for questions or if you just want to talk about programming!",
  CIUEmail: "Email: info@codingisus.com",
  CIUInstagram: "@codingisus",
  CIUFacebook: "@codingisus",
  CIUTikTok: "@codingisus",
  CIUPodcast: "The Coding is Us Podcast",
  PleaseFillOutAllFields: "Please fill out all fields",
  PasswordLengthError: "Password must be at least 6 characters long",
  EmailPasswordMatchError:
    "Your email and password confirmations must match your entered email and password",
  Name: "Name",
  NameDotDotDot: "Name...",
  Email: "Email",
  ...
  ErrorPageMessage: 'Whoops. Not sure how you ended up here. This page might be invalid or has been deleted. Click the button below to go back the home page.',
  Back: "Back",
  ...
  MessageReceivedMessage:
    "Your message has been sent! We'll respond to you as soon as we can via email!",
  PrivacyPolicyText: `
Last updated September 18, 2020


Thank you for choosing to be part of our community at Coding is Us ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at info@codingisus.com.



When you visit our website https://codingisus.com (the "Website"), use our mobile application, as the case may be (the "App") and more generally, use any of our services (the "Services", which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.
...
If you have questions or comments about this notice, you may email us at info@codingisus.com or by post to:
...
1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Coding is Us, located at United States (we, us), concerning your access to and use of the Coding is Us (https://codingisus.com) website as well as any related applications (the Site).  



The Site provides the following services: We give out coding tutorials and practices for free. (Services). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.  
...
●  Our Privacy Notice https://codingisus.com/privacy-policy, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.   
...
9.2  The following terms apply when you use a mobile application obtained from either the Apple Store or Google Play (each an App Distributor) to access the Services: 
...
10.9  Except as stated under the Mobile Application section, a person who is not a party to these Terms and Conditions shall have no right under the Contracts (Rights of Third Parties) Act 1999 to enforce any term of these Terms and Conditions. 



10.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at info@codingisus.com or by post to: 
